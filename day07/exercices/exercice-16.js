...
const entreprise = {
  ...
  employes: [],
   ...
   ajouterEmploye: function(nom, poste, salaire) {
   this.employes.push({
      nom,
      poste,
      salaire
  ...
  afficherEmployes: function(){
    console.log(this.employes);
    
  }
}
//entreprise.ajouterEmploye("omar", "uuuu", 100)
//entreprise.ajouterEmploye("sara", "hhhhh", 100)
//entreprise.ajouterEmploye("ilyas", "hhdhd", 100)
