...
la première notation pointée : syntaxe plus simple, plus lisible, mais limitée
la deuxiéme notation pointée : plus flexible, accepte n’importe quelle chaîne comme clé
...
les deux affichent undefined, mais la situation n est pas la meme
pour distinguer les deux cas, on peut utiliser in ou hasOwnProperty.
Ex :
    "a" in obj; => true
    "b" in obj; => false
